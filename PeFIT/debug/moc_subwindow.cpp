...
QT_MOC_LITERAL(3, 24, 13)
    ...
    "subwindow\0sendFileName\0\0on_OK_clicked"
};
...
void subwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (subwindow::*_t)(QString , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&subwindow::sendFileName)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void subwindow::sendFileName(QString _t1, int _t2)
{
